...
#given $learn-perl6.top-responses(1).list[0] {
    is .[0].response, 'Try the vanilla stout for sure',
        'Most agreeable tip first';
    is .[1].response, 'The lamb kebabs are good!',
        'Next most agreeable tip second';
    is .[2].response, 'Not so keen on the fish burrito!',
...
react {
    whenever $learn-perl6.top-responses.skip(1).head(1) {
        ...
        is .[2].response, 'The pau bahji is super spicy',
            'After adding a tip, correct order (3)';
        is .[3].response, 'Not so keen on the fish burrito!',
...
react {
    whenever $learn-perl6.top-responses.skip(5).head(1) {
        is .[0].response, 'The pau bahji is super spicy',
